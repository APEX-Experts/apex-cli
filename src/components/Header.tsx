...
const PROJECTS_DATA = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
        <path
          d="M12 20v-8m0 0l-3 3m3-3l3 3M4 12a8 8 0 018-8 8 8 0 018 8 8 8 0 01-8 8 8 8 0 01-8-8z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
      </svg>
        ...
        >
                            ...
                            <div className="grid h-full min-h-[360px] grid-cols-1 lg:grid-cols-5">
                              ...
                              <div className="space-y-6 border-r border-white/5 p-6 text-left lg:col-span-3 lg:p-8">
                                <div className="flex items-center gap-4 text-zinc-500">
                                  <span className="font-mono text-[9px] tracking-[0.4em] uppercase text-left">
                                    Service_Registry // SOL_04
                                  </span>
                                  ...
                                  {SERVICES_DATA.map((service) => (
                                    ...
                                    >
                                      ...
                                      <div className="space-y-2 flex-1 text-left">
                                        ...
                                        <p
                                          className={`text-sm leading-relaxed transition-colors duration-500 max-w-md text-left ${
                                            hoveredService.id === service.id
                                              ? "text-zinc-300"
                                              : "text-zinc-500 line-clamp-1"
                                          }`}
                                        >
                                          {service.desc}
                                        </p>
                                ...
                                <AnimatePresence mode="wait">
                                  ...
                                  >
                                    <div className="absolute inset-0 z-0">
                                      ...
                                      />
                                      <div className="absolute inset-0 bg-linear-to-t from-sinai-bg-base via-sinai-bg-base/72 to-sinai-bg-base/80" />
                                    </div>
                                    ...
                                    <div className="relative z-10 flex-1 flex flex-col justify-between">
                                      <div className="space-y-5">
                                        <div className="inline-block px-3 py-1 rounded-sm bg-sinai-glow-orange/10 border border-sinai-glow-orange/20">
                                          <span className="text-[9px] font-mono text-sinai-glow-orange tracking-[0.3em] font-black uppercase">
                                            Technical_Preview
                                          </span>
                                        </div>
                                      ...
                                      <div className="space-y-4 pt-6">
                                        <div className="flex flex-col gap-5">
                                          <div className="flex items-center gap-3">
                                            {hoveredService?.tech?.map(
                                              (slug: string) => (
                                                <div
                                                  key={slug}
                                                  className="group/tech relative"
                                                >
                                                  <div className="w-8 h-8 rounded-lg bg-white/3 border border-white/10 flex items-center justify-center p-1.5 hover:border-sinai-glow-orange/40 transition-colors">
                                                    {slug === "openai" ? (
                                                      <svg
                                                        role="img"
                                                        viewBox="0 0 24 24"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        className="w-5 h-5 fill-white opacity-40 group-hover/tech:opacity-100 transition-opacity"
                                                      >
                                          ...
                                          <div className="space-y-2">
                                            <div className="text-[10px] font-mono text-zinc-500 tracking-[0.5em] uppercase">
                                              {hoveredService.detail}
                                            </div>
                                            <h4 className="text-2xl font-black tracking-normal text-white uppercase leading-none">
                                      ...
                                      <div className="space-y-5">
                                        <div className="flex items-center justify-between">
                                          ...
                                          <div className="flex gap-1.5">
                                            <div
                                              className={`w-1.5 h-1.5 rounded-full bg-sinai-glow-orange/40 ${effectiveReduceMotion ? "" : "animate-pulse"}`}
                                            />
          ...
          <div className="flex items-center gap-6">
            ...
            >
              Connect_Node
              <div
                className={`h-1.5 w-1.5 rounded-full bg-white/60 group-hover:bg-sinai-glow-orange ${effectiveReduceMotion ? "" : "animate-pulse"}`}
              />
            </Link>
          ...
          >
            ...
            <div className="mb-10 flex items-center justify-between sm:mb-14 z-101 ">
              ...
              <button
                ...
                className="text-white text-xs font-mono uppercase tracking-widest"
              >
                Close_X
              </button>
            </div>
