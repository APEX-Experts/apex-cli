        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6 w-full items-center">
          ...
          <div className="flex flex-col justify-center z-20 w-full text-left gap-6">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-[64px] font-black leading-7 lg:leading-20 tracking-tight text-white"
            >
            ...
            <motion.p
              ...
              className="text-base text-white-200 max-w-lg leading-[29.25px]"
            >
              We design and deliver enterprise software systems, web platforms,
              and AI-integrated environments that operate within your existing
              architecture, connect your data, and support
            </motion.p>

            {/* ── Stats Area ── */}
            <div className="col-span-1 flex flex-col border-t border-white/10 z-20 relative py-2.5">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                {[
                  ...
                  <div key={idx} className="flex flex-col gap-1">
                    <span className="text-2xl lg:text-3xl font-black text-white leading-[36px]">
                      {s.val}
                    </span>
                    <span className="text-sm text-white uppercase font-bold tracking-[0.2em] leading-[13.5px]">
                      {s.label}
                    </span>
                  </div>
                ))}
            ...
            >
              <Link
                href="#services"
                className="group flex items-center gap-4 bg-sinai-glow-orange text-white px-8 lg:px-10 h-16 rounded-full font-black md:text-lg tracking-widest hover:scale-105 transition-all shadow-[0_15px_40px_rgba(217,130,47,0.3)] "
              >
                <HeroCTA
                  width={20}
                  height={20}
              ...
              <Link
                href="#services"
                className="group flex items-center gap-4 border border-white bg-white/5 px-8 lg:px-10 h-16 rounded-full font-black text-white md:text-lg tracking-widest hover:bg-white/10 transition-all"
              >
                Our Services
              </Link>
            </motion.div>
          ...
          {/* ── Right Content: Robot ── */}
          <div className="relative w-full h-[450px] sm:h-[550px] lg:h-[650px] z-40 order-first lg:order-0 mb-10 lg:mb-0 flex items-end justify-center">
