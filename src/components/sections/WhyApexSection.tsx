        ...
        <div className="lg:col-span-2">
          <div className="sticky top-32">
            ...
            <div className="mt-12 rounded-2xl border border-white/15 why-us-gradient p-8 text-center md:text-start">
              ...
              <Link
                href="/contact"
                className="group flex items-center gap-4 bg-sinai-glow-orange text-white px-8 lg:px-10 h-10 rounded-full font-black text-xs md:text-lg tracking-widest transition-all duration-300 hover:shadow-[0_15px_40px_rgba(217,130,47,0.3)]  w-full md:w-fit max-md:justify-center"
              >
