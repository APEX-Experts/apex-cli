    ...
    <section className="section-shell relative py-24 overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 mx-auto text-center">
        <motion.div
          ...
          className="space-y-8"
        >
          <h2 className="text-3xl font-bold leading-[140%] tracking-[-0.075rem] text-white md:text-5xl">
            Ready to assess your <br />
            <span className="text-sinai-glow-orange">system architecture?</span>
          </h2>

          <p className="mx-auto text-lg leading-relaxed text-zinc-400 sm:text-xl">
          ...
          <div className="pt-8 pb-12">
            <Link
              href="/contact"
              className="group flex items-center gap-4 bg-sinai-glow-orange text-white px-8 lg:px-10 h-16 rounded-full font-black md:text-lg tracking-widest transition-all duration-300 hover:shadow-[0_15px_40px_rgba(217,130,47,0.3)] w-full md:w-fit mx-auto max-md:justify-center"
            >
