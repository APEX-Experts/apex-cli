          ...
          <div className="mx-auto mb-14 max-w-5xl space-y-6 lg:mb-20">
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              <div className="rounded-sm border border-sinai-glow-orange/25 bg-sinai-glow-orange/[0.08] px-4 py-1.5">
                <span className="text-[10px] font-mono font-black uppercase tracking-[0.34em] text-sinai-glow-soft">SYSTEM_MANIFEST // CORE_CAPABILITIES</span>
              </div>
            </div>
            ...
            <SectionReveal key={service.id}>
              <div className="group relative grid grid-cols-1 items-start gap-8 lg:grid-cols-12 lg:gap-10">
                ...
                <div className="lg:col-span-1 hidden lg:flex flex-col items-center pt-4">
                  <div className="text-4xl font-black text-white/5 transition-colors duration-300 group-hover:text-sinai-glow-orange/20">{service.id}</div>
                ...
                <div className="space-y-6 lg:col-span-7">
                  <div className="space-y-6">
                    <div className="flex items-center gap-5">
                      <div className="relative flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-[1.25rem] border border-white/10 bg-white/[0.03] text-sinai-glow-orange shadow-[0_24px_80px_rgba(0,0,0,0.28)] transition-all duration-300 group-hover:border-sinai-glow-orange/25">
                ...
                <div className="lg:col-span-4 lg:pt-8">
                  <Link href={`/services/${service.slug}`} className="apex-panel apex-panel-hover group/btn relative block overflow-hidden rounded-[1.5rem] p-6 lg:p-8">
