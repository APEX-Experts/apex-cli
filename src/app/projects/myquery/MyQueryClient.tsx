      ...
      <section className="relative isolate flex min-h-[86svh] items-center overflow-hidden bg-[linear-gradient(180deg,#06080a_0%,#080a0d_50%,#06080a_100%)] pt-28 lg:pt-32">
        ...
        <div className="apex-container-wide relative z-10">
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(24rem,0.82fr)] lg:gap-10 xl:grid-cols-[minmax(0,1.05fr)_minmax(30rem,0.9fr)]">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="relative z-20 w-full min-w-0 max-w-3xl space-y-8 text-left">
              <div className="space-y-6">
                <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                  ...
                  <span className="text-[9px] uppercase tracking-[0.24em] text-sinai-glow-orange font-bold sm:tracking-[0.5em]">AI_ANALYTICS_PLATFORM // MYQ_V5</span>
                </div>
                <h1 className="max-w-full text-balance text-5xl font-black uppercase tracking-normal leading-[0.88] text-white sm:text-6xl md:text-7xl xl:text-8xl 2xl:text-9xl">MYQUERY<br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-sinai-glow-orange via-white to-white/40">Intelligence.</span></h1>
                <p className="max-w-full text-base leading-relaxed text-zinc-400 sm:text-xl md:text-2xl font-light">The AI analytics platform that puts data in everyone&apos;s hands. Type a question in plain English, and get accurate reports instantly.</p>
              </div>
              <div className="flex flex-wrap gap-6">
                ...
                <div className="inline-flex w-full items-center justify-center gap-4 rounded-full border border-white/10 bg-white/[0.03] px-6 py-5 text-center font-mono text-[10px] tracking-widest text-zinc-400 sm:w-auto sm:px-8 sm:py-6">
                  <span className={`w-2 h-2 rounded-full bg-sinai-glow-orange ${effectiveReduceMotion ? '' : 'animate-pulse'}`} />
                  CORE_READY_0x5
                </div>
              </div>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, rotate: 5 }} animate={{ opacity: 1, scale: 1, rotate: 0 }} transition={{ duration: 1, ease: "easeOut", delay: 0.2 }} className="relative z-10 w-full justify-self-end lg:max-w-[34rem] xl:max-w-[40rem] 2xl:max-w-2xl">
              <div className="relative aspect-square max-w-2xl mx-auto rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_0_72px_rgba(217,130,47,0.08)] group bg-zinc-950">
                <Image src="/images/myquery-premium.png" alt="MyQuery Interface" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover opacity-80 group-hover:scale-110 transition-transform duration-[5000ms]" priority />
            ...
            <SectionReveal>
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <h2 className="text-6xl md:text-7xl font-black tracking-normal leading-none uppercase">Information is <br /><span className="text-zinc-800">Siloed.</span></h2>
                </div>
            ...
            <SectionReveal>
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <h2 className="text-6xl md:text-7xl font-black tracking-normal leading-none uppercase">MyQuery is the <br /><span className="text-white">Neural Hub.</span></h2>
                </div>
                <div className="space-y-7">
        ...
        <div className="apex-container-wide">
          <SectionReveal>
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h2 className="text-6xl md:text-8xl font-black mb-10 tracking-normal leading-none uppercase">The Intelligence <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-sinai-glow-orange to-white/40">Powering MyQuery</span></h2>
            </div>
          </SectionReveal>
          ...
          <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
            ...
            <div className="apex-container-wide relative z-10">
              <div className="max-w-4xl mb-10 lg:mb-12">
                ...
                <h2 className="text-6xl md:text-8xl font-black tracking-normal leading-none uppercase">The Intelligence <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-sinai-glow-orange/30">Pipeline.</span></h2>
              </div>
                ...
                <div className="lg:col-span-5 relative space-y-8">
                  {PIPELINE_STEPS.map((item, i) => (
                    <div key={i} className={`group relative space-y-6 transition-all duration-700 ${activeStep === i ? 'opacity-100 scale-105' : 'opacity-20 scale-95 blur-[1px]'}`}>
                      ...
                      <div className="space-y-4"><h3 className={`text-3xl font-black tracking-normal uppercase transition-colors duration-500 ${activeStep === i ? 'text-white' : 'text-zinc-600'}`}>{item.title}</h3><p className={`text-base font-light leading-relaxed transition-colors duration-500 ${activeStep === i ? 'text-zinc-400' : 'text-zinc-700'}`}>{item.desc}</p></div>
