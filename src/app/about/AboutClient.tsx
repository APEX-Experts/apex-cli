            ...
            >
              <div className="space-y-4">
                ...
                <h1 className="text-4xl font-black uppercase leading-[0.92] tracking-normal md:text-6xl">
                  ...
                  <span className="apex-gradient-text">Enterprise Systems</span>
                </h1>
              </div>
              ...
              <div className="space-y-5 text-zinc-400 text-lg md:text-xl leading-relaxed font-light italic">
                ...
                <p className="relative">
                  APEX Experts operates across four core capabilities: Oracle APEX development, AI integration, web development, and mobile development. These are not isolated service lines. They are connected engineering disciplines that allow us to address the full complexity of an enterprise system.<span className="absolute -right-8 -bottom-4 text-6xl font-serif text-sinai-glow-orange/20 rotate-180">&quot;</span>
                </p>
              </div>
