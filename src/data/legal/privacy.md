...
Security is a shared responsibility. APEX is responsible for the systems, code, infrastructure, and processes under its control. Customers are responsible for their own users, credentials, permissions, identity providers, connected systems, configuration choices, data classification, and compliance obligations.
...
## 8. Regional Privacy Considerations
